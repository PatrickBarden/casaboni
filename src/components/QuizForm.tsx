...
export default function QuizForm() {
  ...
  return (
    <section className="py-24 bg-primary relative" id="contato">
      ...
      <div className="max-w-4xl mx-auto px-8 relative z-10">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-surface p-12 shadow-ambient"
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary uppercase tracking-tighter mb-2">Solicite seu Orçamento Curator</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            {/* Step 1: Environment */}
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-action mb-6">1. Tipo de Ambiente</label>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <button
                    ...
                    className={`border p-4 text-center transition-all flex flex-col items-center gap-2 ${
            ...
            {/* Step 2: Measurements */}
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-action mb-6">2. Metragem Aproximada</label>
            ...
            <div className="pt-6">
              <button 
                type="submit"
                className="w-full py-5 bg-primary text-white font-bold tracking-[0.2em] uppercase text-sm hover:bg-primary/90 transition-colors flex items-center justify-center gap-4"
              >
